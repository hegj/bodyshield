...
public class SPUtils {
    ...
    public static  void setTempertureToServerRecordTime(long time,String address){
            SharedPreferencesUtil.setLongValue(Constant.KEY_TEMPERTURE_RECORD_NET_TIME + address +UIUtils.getUserId(), time);
    }  public static  long getTempertureToServerRecordTime( String address){
          return   SharedPreferencesUtil.getLongValue(Constant.KEY_TEMPERTURE_RECORD_NET_TIME + address +UIUtils.getUserId(), 0);
    }
}
