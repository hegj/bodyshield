...
public class PagerSlidingTabStripExtends extends HorizontalScrollView {
    ...
    private int							indicatorColor			= 0xFF666666;//R.color.base;
    private int							underlineColor			= Color.TRANSPARENT;//0x1A000000;
    private int							dividerColor			=  Color.TRANSPARENT;

    private boolean						shouldExpand			= true;//是否自动扩展,让tab条目少时自动平均分布
