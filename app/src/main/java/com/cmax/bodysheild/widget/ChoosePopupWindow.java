...
public class ChoosePopupWindow {
    ...
    private void initView() {
        final RelativeLayout popupView = (RelativeLayout) View.inflate(UIUtils.getContext(), R.layout.popupwindow_below_menu, null);
    ...
    public void setMenuLeftText(String oneText, String twoText, String third ) {
